...
public class ViewAlterLivro extends JFrame {
	 ...
	 * Create the frame.
	 */
	static ArrayList<AuthorModel> autoresSelecionados = new ArrayList<AuthorModel>();
	
	

	
	 static String editoraDoLivro;
	PublisherModel editora;
	
	public PublisherModel getEditora() {
		return editora;
	}

	public static void setEditora(PublisherModel editora) {
	editora = editora;
	}

	public static String getEditoraDoLivro() {
	...
	public ViewAlterLivro() throws Throwable {
		...
		buttonEditAutor.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				try {
					ViewSelectAutor viewSelectAutor = new ViewSelectAutor(jCampoISBN.getText());
					System.out.println(jCampoISBN.getText());
		...
		CriaViewSelectAutor.preencheComboBox(comboBoxEditora);
