...
public class aButtonEditEditora implements ActionListener{
	...
	public void actionPerformed(ActionEvent e) {
		...
		viewAlterEditora.setjCampoNome(String.valueOf(table.getValueAt(table.getSelectedRow(), 0)).trim());
		viewAlterEditora.setjCampoURL(String.valueOf(table.getValueAt(table.getSelectedRow(), 1)).trim());
		viewAlterEditora.setId_editora(String.valueOf(table.getValueAt(table.getSelectedRow(), 4)).trim());
